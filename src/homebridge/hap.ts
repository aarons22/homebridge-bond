...
export namespace HAP {
  ...
  export interface Characteristic {
    [key: string]: any;
    on(eventType: 'get', callback: (err: any, value: any) => void): Characteristic;
    on(eventType: 'set', handler: (value: any, callback: (err?: Error) => void) => void): Characteristic;
...
class Hap {
  // @ts-ignore
  public PlatformAccessory: new (displayName: string, uuid: string, category: number) => HAP.Accessory;
  // @ts-ignore
  public Service: {
    [key: string]: any;
  };
